...
--
-- Host: localhost:3306
-- Generation Time: Jun 17, 2020 at 03:30 PM
...
(1, 'Cristian Daniel', '2@2', 'Funciona'),
(2, 'Tamara', 'tami@mail', 'la pagina funciona correctamente '),
(3, 'Pedro', 'pedro@mail', 'Esta pagina es genial para reservar vuelos!!!'),
(4, 'Cristian', 'cris@hotmail.com', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc malesuada in erat ut faucibus. Suspendisse ultricies magna eu risus commodo, ac scelerisque lectus cursus.'),
(5, 'Rodolfo', 'correo@co', 'Hola, funciona correctamente'),
(6, 'Cris', 'cris@mail', 'testimonial desde el metodo del controller');
